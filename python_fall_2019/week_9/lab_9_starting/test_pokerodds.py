...
Starting code for computing poker odds,
    plus two Pytest tests at end:
    check for one pair, check for two pairs
'''
...
# Here's two Python classes whose objects represent a playing card and a deck of such cards
...
def main():
    ...
    for num in range(TRIALS):
        ...
        # pass in this dictionary to make hand checking easier
...
def card_example(): # call this by editing code below
    ...
    """
        Test Card: create default Card, then another
